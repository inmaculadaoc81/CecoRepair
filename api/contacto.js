...
module.exports=async(req,res)=>{
  if(req.method==="GET"){
    ...
    return res.status(200).json({
      ok:true,
      service:"CecotecRepair contacto API",
  ...
  try{
    ...
    await transporter.sendMail({
      from:`"CecotecRepair" <${process.env.SMTP_USER}>`,
      to:process.env.CONTACT_EMAIL||process.env.SMTP_USER,
      replyTo:email,
      subject:"Nueva consulta CecotecRepair - robotsaspiradores.com.es",
      text:`Nueva consulta CecotecRepair
...
${mensaje}`
    ...
    console.error("CecotecRepair SMTP error",{
